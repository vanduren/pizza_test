...
<div class="py-6 px-4">
    ...
    <div>
        <form method="post" action="{{ route('unit.update', $unit) }}">
            ...
            <input type="submit" value="wijzig eenheid" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded">
        </form>
    </div>
</div>
@endsection
